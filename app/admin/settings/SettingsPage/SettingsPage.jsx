...
export default function SettingsPage() {
  ...
  return (
    <section className={m('settings-dashboard')}>
      <div className={m('settings-dashboard__intro')}>
      ...
      <div className={m('settings-dashboard__grid')}>
        {items.map((item) => {
          ...
          return (
            <Link
              key={item.href}
              href={item.href}
              className={m('settings-dashboard__card')}
            >
              <div className={m('settings-dashboard__cardTop')}>
                <div className={m('settings-dashboard__icon')}>
                  <Icon size={22} />
                </div>

                <div className={m('settings-dashboard__arrow')}>
                  <ChevronRight size={18} />
                </div>
              </div>

              <div className={m('settings-dashboard__content')}>
                <h3>{item.title}</h3>
