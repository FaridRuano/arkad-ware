...
const page = () => {
  ...
  return (
    <>
      ...
      />
      <div className={m('admin__dashboard clients__page')}>
        {/* 1) Filtros */}
        <section className={m('clients__filters')}>
          <header className={m('clients__filtersHeader')}>
            <h1 className={m('clients__title')}>Barberos</h1>

            <div className={m('clients__filtersActions')}>
              <button
                className={m('__button primary clients__btnNew')}
          ...
          <div className={m('clients__filtersGrid')}>
            <div className={m('field clients__field clients__fieldSearch')}>
            ...
            <table className={m('clients__table')}>
              <thead className={m('clients__thead')}>
                <tr className={m('clients__tr clients__trHead')}>
                  <th className={m('clients__th')}>Barbero</th>
                  <th className={m('clients__th')}>Teléfono</th>
                  <th className={m('clients__th')}>Estado</th>
                  <th className={m('clients__th')}>Color</th>
              ...
              <tbody className={m('clients__tbody')}>
                {loading && (
                  <tr className={m('clients__tr')}>
                    <td className={m('clients__td clients__tdState')} colSpan={6}>
                      <div className={m('clients__state clients__stateLoading')}>
                        <span className={m('clients__stateTitle')}>Cargando barberos…</span>
                ...
                {!loading && !error && (barbers?.length ?? 0) > 0 &&
                  barbers.map((b) => {
                    ...
                    return (
                      <tr className={m('clients__tr')} key={id}>
                        <td className={m('clients__td')}>{name}</td>
                        <td className={m('clients__td')}>{b?.phone ?? '—'}</td>
